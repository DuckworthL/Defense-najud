        ...
        <div class="card-body">
            ...
            <form action="{{ route('leave-types.update', $leaveType) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="description" name="description" rows="3" required>{{ old('description', $leaveType->description) }}</textarea>
                </div>
                
                <div class="form-group">
                    <label>Is Paid Leave? <span class="text-danger">*</span></label>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="is_paid" id="is_paid_yes" value="1" {{ old('is_paid', $leaveType->is_paid) == 1 ? 'checked' : '' }}>
                        <label class="form-check-label" for="is_paid_yes">
                            Yes - This leave type is paid
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="is_paid" id="is_paid_no" value="0" {{ old('is_paid', $leaveType->is_paid) == 0 ? 'checked' : '' }}>
                ...
                <div class="form-group">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="is_active" name="is_active" value="1" {{ old('is_active', $leaveType->is_active) == 1 ? 'checked' : '' }}>
